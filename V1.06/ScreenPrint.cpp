...
//--定义全局变量
int RowAngle = 20;//滚轮转多少度换行
int RowLimit = 60;//行数限制
char FileName[5];
int Counter = 1;
//初始化
int Page = 0;
...
int List(void)
{
  ...
  int LM1R = 18, LM2R = 19, LM3R = 20, RM1R = 11, RM2R = 12, RM3R = 13;//底盘电机端口号
  int Motor1R = 16, Motor2R = 15, Motor3R = 0, Motor4R = 0;//其他电机端口号,默认先填1和2
