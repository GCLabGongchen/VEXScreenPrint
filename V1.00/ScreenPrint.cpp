...
int List(void)
{
  int LM1 = 1, LM2 = 2, LM3 = 3, RM1 = 8, RM2 = 9, RM3 = 10;//底盘电机端口号-1
  int Motor1 = 4, Motor2 = 7, Motor3 = 0, Motor4 = 0;//其他电机端口号,默认先填1和2
  ...
  while(1)
  {
    ...
    if(LM3 !=0 && RM3 != 0)
    {
      LinePrint(19+RowChange,5,2,"MotorPort",LM1,"Status");
      ...
      LinePrint(23+RowChange,5,2,"MotorPort",LM2,"Status");
      ...
      LinePrint(27+RowChange,5,2,"MotorPort",LM3,"Status");
      ...
      LinePrint(31+RowChange,5,2,"MotorPort",RM1,"Status");
      ...
      LinePrint(35+RowChange,5,2,"MotorPort",RM2,"Status");
      ...
      LinePrint(39+RowChange,5,2,"MotorPort",RM3,"Status");
      ...
      LinePrint(43+RowChange,5,2,"MotorPort",Motor1,"Status");
      ...
      LinePrint(47+RowChange,5,2,"MotorPort",Motor2,"Status");
    ...
    else if(RM3 == 0 && LM3 == 0)
    {
      ...
      LinePrint(23+RowChange,5,2,"MotorPort",LM2,"Status");
        ...
        LinePrint(25+RowChange,10,1,"Current",vexMotorCurrentGet(LM2));
        LinePrint(26+RowChange,10,1,"Voltage",vexMotorVoltageGet(LM2));
      LinePrint(27+RowChange,5,2,"MotorPort",RM1,"Status");
      ...
      LinePrint(31+RowChange,5,2,"MotorPort",RM2,"Status");
      ...
      LinePrint(35+RowChange,5,2,"MotorPort",Motor1,"Status");
      ...
      LinePrint(39+RowChange,5,2,"MotorPort",Motor2,"Status");
      ...
      LinePrint(43+RowChange,5,2,"MotorPort",Motor3,"Status");
      ...
      LinePrint(47+RowChange,5,2,"MotorPort",Motor4,"Status");
